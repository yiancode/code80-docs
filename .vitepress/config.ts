    ...
    nav: [
      ...
      { text: 'Grok Build', link: '/grok/' },
      {
        ...
        items: [
          ...
          { text: '接口文档（gpt-5.5 / gpt-image-2）', link: '/guide/api-reference' },
      ...
      '/grok/': [
        {
          ...
          items: [
            ...
            { text: '官方安装', link: '/grok/install' },
            { text: 'Code80 中转配置', link: '/grok/config' },
            { text: '排障与常见问题', link: '/grok/faq' }
          ]
        },
        {
          text: '其他工具',
